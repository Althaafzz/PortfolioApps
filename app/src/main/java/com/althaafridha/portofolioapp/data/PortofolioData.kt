...
object PortfolioData {
    ...
    private val detailExperience = arrayOf(
        "Sertifikat ini merupakan sertifikat yang di terbitkan langsung oleh Google untuk Developer Android",
        ...
        "Memulai program bahasa Phython merupakan course yang bertujuan untuk mempelajari bahasa Phython",
        "solid princple mempelajari tentang oop, clean code, dll"
    )
